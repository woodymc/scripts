...
for host in ${IDENTHOST}; do
        ...
        if [ "$loss" == 100 ]; then
                printf "║ \033[34;1m$host\033[0m\x09IP: $ip|\033[32;1m$geo\033[0m\x09ping: \033[31;1mNot response\033[0m\x09\033[33;1mloss: $loss\x25\033[0m\x09║\n"
        else
                printf "║ \033[34;1m$host\033[0m\x09IP: $ip|\033[32;1m$geo\033[0m\x09ping: $avg(AVG)\x09\033[33;1mloss: $loss\x25\033[0m\x09║\n"
        fi
done
printf "║                                                                               ║\n"
printf "╚═══════════════════════════════════════════════════════════════════════════════╝\n"
